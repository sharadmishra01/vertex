package demo.discovery.dbhandler;
...
public class VertxDiscoveryResponseDBHandlerService extends AbstractVerticle {
	...
	private static final int DEFAULT_CLIENT_PORT = 9232;
	private static final String DEVICES_COLLECTION_NAME = "discoveredDevices";
	...
	public void start() throws Exception {
		...
		mongo = MongoClient.createShared(vertx,
				new JsonObject().put("db_name", "test").put("host", "192.168.99.100"));
